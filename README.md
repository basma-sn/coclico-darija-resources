...
extraction du vocabulaire du texte CoCLiCo-darija ;
extraction des mots arabes uniques à partir du fichier sentences.csv de DODa ;
génération de propositions de prononciation en X-SAMPA ;
fusion de plusieurs dictionnaires .dict ;
suppression des doublons strictement identiques tout en conservant les variantes de prononciation.
